...
serve(async (req) => {
  ...
  try {
    ...
    console.log('[Shopee Status] Checking for user:', userId)
    ...
    if (error || !tokenData) {
      console.log('[Shopee Status] No token found for user')
      return new Response(
    ...
    console.log('[Shopee Status] Token found, expired:', isExpired, 'can_refresh:', canRefresh)
